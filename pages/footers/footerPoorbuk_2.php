...
if ($myUserURLFinalPath == "poorbuk.php") { echo '    
        <script type="text/javascript" src="/application/modules/phpgeneral/scripts/phpgeneralReloadPostsByScrollAuto.js"></script>	
	<script type="text/javascript" src="/application/modules/phpgeneral/scripts/phpgeneralReloadPostsByScrollAutoShowPosts.js"></script>	
	...
	<script type="text/javascript" src="/application/modules/phpfront/scripts/phpfrontFileImageUploadCSS.js"></script>
