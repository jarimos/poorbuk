 ...
 */
	...
	{
                    /*
                    echo'<br><br><br><br>   <div class="w3-container">
                    <h2>User List Avatar</h2>
                    <p>You can combine w3-ul and the w3-bar classes to create an avatar list:</p>
                    <ul class="w3-ul w3-card-4 w3-xlarge" style="width:70%;margin:auto;" >


                      <li id="'.$row{'userid'}.'" class="w3-bar">

                        <span onclick="this.parentElement.style.display="none" " class="w3-bar-item w3-button w3-white  w3-right">×</span>
